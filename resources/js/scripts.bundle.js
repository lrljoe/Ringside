    ...
    return {
            ...
            return {
                ...
                remove: function(name) {
                    if (element && this.has(name)) {
                        delete KTUtilElementDataStore[element.customDataTag][
                            name
                        ];
                    }
                }
        ...
        on: function(element, selector, event, handler) {
            ...
            KTUtil.addEvent(
                element,
                event,
                KTUtilDelegatedEventHandlers[eventId]
            );
            ...
            columnHide: function() {
                ...
                $.each(options.columns, function(i, column) {
                    if (typeof column.responsive !== "undefined") {
                        ...
                        if (
                            util.getBreakpoint(column.responsive.hidden) >=
                            screen
                        ) {
                            $(tds).hide();
                        } else {
                        ...
                        if (
                            util.getBreakpoint(column.responsive.visible) <=
                            screen
                        ) {
                            $(tds).show();
                        } else {
                    ...
                    left: function() {
                        ...
                        if (KTUtil.isInResponsiveRange("desktop")) {
                            if (KTUtil.hasClass(body, "kt-aside--minimize")) {
                                ...
                                KTUtil.hasClass(body, "kt-aside--enabled")
                            ) {
                                left += asideWidth;
                            }
                        }
