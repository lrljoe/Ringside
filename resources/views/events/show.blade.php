                            ...
                            <div class="kt-widget__head">
                                ...
                                <div class="kt-widget__content">
                                    <div class="kt-widget__section">
                                        <span class="kt-widget__username">{{ $event->name }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-widget__body">
                                <div class="kt-widget__content">
                                    <div class="kt-widget__info">
                                        ...
                                        <span class="kt-widget__data">{{ $event->date->toDateString() }}</span>
                                    </div>
                                    <div class="kt-widget__info">
                                        <span class="kt-widget__label">Venue:</span>
                                        <span class="kt-widget__data">{{ $event->venue->name }}</span>
                                    </div>
                                </div>
                                <p>{{ $event->preview }}</p>
                            </div>
