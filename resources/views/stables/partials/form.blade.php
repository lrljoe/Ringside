<div class="mb-10">
    <x-form.inputs.text label="Name:" name="name" placeholder="Stable Name Here" :value="old('name')"/>
</div>

<div class="mb-10">
    <x-form.inputs.date label="Start Date:" name="start_date" :value="old('start_date')"/>
</div>
