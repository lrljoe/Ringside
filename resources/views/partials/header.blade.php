                    ...
                    <div class="my-5 menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                        <div class="menu-item me-lg-1">
                            <span class="py-3 menu-link">
                                <a class="py-3 menu-link" href="{{ route('dashboard') }}">
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                        <div class="menu-item">
                                            <a class="py-3 menu-link" href="{{ route('wrestlers.index') }}">
                                        ...
                                        <div class="menu-item">
                                            <a class="py-3 menu-link" href="{{ route('tag-teams.index') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="py-3 menu-link" href="{{ route('managers.index') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="py-3 menu-link" href="{{ route('referees.index') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                        ...
                                        <div class="menu-item">
                                            <a class="py-3 menu-link" href="{{ route('stables.index') }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <div class="menu-item menu-lg-down-accordion">
                                    <a class="py-3 menu-link" href="{{ route('titles.index') }}">
                                        <span class="menu-icon">
                                ...
                                <div class="menu-item menu-lg-down-accordion">
                                    <a class="py-3 menu-link" href="{{ route('venues.index') }}">
                                        <span class="menu-icon">
                                ...
                                <div class="menu-item menu-lg-down-accordion">
                                    <a class="py-3 menu-link" href="{{ route('events.index') }}">
                                        <span class="menu-icon">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="px-3 menu-item">
                            <div class="px-3 menu-content d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <span href="#" class="fw-bold text-muted fs-7">{{ auth()->user()->email }}</span>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="px-5 menu-item">
                            <a data-action="{{ route('logout') }}" data-method="post" data-csrf="{{ csrf_token() }}" data-reload="true" class="px-5 button-ajax menu-link">
                                {{ __('Sign Out') }}
                            </a>
                        </div>
                        <!--end::Menu item-->
