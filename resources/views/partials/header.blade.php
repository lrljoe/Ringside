            ...
            <div class="flex-shrink-0 app-navbar">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('assets/media/avatars/300-1.jpg') }}" alt="{{ auth()->user()->first_name }} {{ auth()->user()->last_name }}">
                    </div>
                    ...
                    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="px-3 menu-item">
                            <div class="px-3 menu-content d-flex align-items-center">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="{{ auth()->user()->first_name }} {{ auth()->user()->last_name }}" src="{{ asset('assets/media/avatars/300-1.jpg') }}">
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="px-5 menu-item">
                            <a data-action="{{ route('logout') }}" data-method="post" data-csrf="{{ csrf_token() }}" data-reload="true" class="px-5 menu-link">Sign Out</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
