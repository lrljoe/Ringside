...
test('it retires the current tag teams and current wrestlers and current manages of a stable', function () {
    ...
    WrestlerRetireAction::shouldRun()->times(3);
    ManagerRetireAction::shouldRun()->times(2);
