...
class UpdateStableFailureConditionsTest extends TestCase
{
    ...
    {
        $this->actAs(Role::ADMINISTRATOR);
        StableFactory::new()->create(['name' => 'Example Stable Name']);
        $stableB = StableFactory::new()->create();
    ...
    {
        $this->actAs(Role::ADMINISTRATOR);
        $stable = StableFactory::new()->states('bookable')->create();
    ...
    {
        $this->actAs(Role::ADMINISTRATOR);
        $otherStable = StableFactory::new()->states('bookable')->create();
        $stable = StableFactory::new()->states('bookable')->create();
