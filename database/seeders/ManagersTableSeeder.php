...
class ManagersTableSeeder extends Seeder
{
    ...
    public function run(mixed $dateToStart = null): void
    {
        ...
        for ($j = $eNum; $j <= 30; $j++) {
            ...
            $employment = ManagerEmployment::factory()->started($start);
        ...
        for ($i = 1; $i <= 10; $i++) {
            ...
            $employment = ManagerEmployment::factory()->started($start)->ended($end);
            $retirement = ManagerRetirement::factory()->started($end);
            Manager::factory()
